                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder="BIRTHDATE" name="birthday" required="required" max="2023-08-04">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Contact Number" name="contact" maxlength="10" required="required" >
                        </div>
